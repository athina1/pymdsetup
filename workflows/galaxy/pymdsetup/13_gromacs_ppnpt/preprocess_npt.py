...
def create_mdp_file(arglist, basepath):
    argnames = ['title', 'define', 'integrator', 'nsteps', 'dt', 'nstxout', 'nstvout', 'nstenergy',
            'nstlog', 'continuation', 'constraint_algorithm', 'constraints', 'lincs_iter',
            'lincs_order', 'cutoff-scheme', 'ns_type', 'nstlist', 'rcoulomb', 'rvdw',
            'coulombtype', 'pme_order', 'fourierspacing', 'tcoupl', 'tc-grps', 'tau_t',
            'ref_t', 'pcoupl', 'pcoupltype', 'tau_p', 'ref_p', 'compressibility',
            'refcoord_scaling', 'pbc', 'DispCorr', 'gen_vel'
            ]
