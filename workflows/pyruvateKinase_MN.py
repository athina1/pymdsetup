...
@task(input_tpr_path=FILE_IN, output_gro_path=FILE_OUT, output_cpt_path=FILE_OUT)
def mdrun_pc_cpt(input_tpr_path, output_trr_path, output_gro_path, output_cpt_path, properties, **kwargs):
    mdrun.Mdrun(input_tpr_path=input_tpr_path, output_trr_path=output_trr_path, output_gro_path=output_gro_path, output_cpt_path=output_cpt_path, properties=properties, **kwargs).launch()
...
def mdrun_pc(input_tpr_path, output_trr_path, output_gro_path, properties, **kwargs):
    mdrun.Mdrun(input_tpr_path=input_tpr_path, output_trr_path=output_trr_path, output_gro_path=output_gro_path, properties=properties, **kwargs).launch()
